...
`Marie_EDA.Rmd` Marie examined the statistical relationships between various variables, diving deeper into cancellations and delays.<be>

`Rohan_EDA.ipynb` Rohan explored the distributions of cancellations and delays, aiming to determine the impact of self-induced delays and specific routes.<be>
